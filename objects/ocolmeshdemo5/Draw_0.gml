...
var ray = levelColmesh.castRay(global.camX, global.camY, global.camZ, global.camX + v[0] * 1000, global.camY + v[1] * 1000, global.camZ + v[2] * 1000);
...
if global.drawDebug
{
	...
	var r = radius * 1.1;
	levelColmesh.debugDraw(levelColmesh.getRegion([x - r, y - r, z - r, x + r, y + r, z + height + r]));
	matrix_set(matrix_world, matrix_build_identity());
}
