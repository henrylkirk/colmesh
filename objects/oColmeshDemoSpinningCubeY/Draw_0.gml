...
shader_set_uniform_f(shader_get_uniform(sh_colmesh_collider, "u_color"), .8,0.5, .4);
matrix_set(matrix_world, matrix_multiply(matrix_build(0, 0, 0, 0, 0, 0, size / 2, size / 2, size / 2), shape.matrix));
