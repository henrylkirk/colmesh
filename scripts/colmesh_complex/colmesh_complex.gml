...
function colmesh_complex(_colMesh, _xup, _yup, _zup) constructor {
    ...
    static step = function(iterations) {
        ...
        y = (minY + maxY) * 0.5;
        z = (minZ + maxZ) * 0.5;
        var radius = (max(maxX - minX, maxY - minY, maxZ - minZ) * 0.5) + (R / nodeNum);
        spdX /= nodeNum;
        spdY /= nodeNum;
        spdZ /= nodeNum;
    ...
    /// @function addNode(x, y, z, radius, weight, movable)
    static addNode = function(_x, _y, _z, _radius, _weight, _movable) {
        static node = function(_x, _y, _z, _radius, _weight, _movable) constructor {
            ...
            static step = function(amount) {
                ...
                y += spdY * amount;
                z += spdZ * amount;
                var col = parent.colMesh
                    .regionDisplaceCapsule(
                    parent.region,
                    x,
                    y,
                    z,
    ...
    /// @function connectRigid(A, B, solid)
